...
import com.logistics.tracking.constant.ApiPath;
...
@Slf4j
@RestController
@RequestMapping(ApiPath.SEARCH_BASE)
...
public class ParcelSearchController {
    ...
    @GetMapping(ApiPath.AUTOCOMPLETE)
    ...
    @PostMapping(ApiPath.GEO_NEARBY)
    ...
    @GetMapping(ApiPath.CLUSTER_HEALTH)
