 ...
 * into Spring Security GrantedAuthority instances (e.g. ROLE_ADMIN, ROLE_COURIER, ROLE_MERCHANT, ROLE_CUSTOMER),
...
public class KeycloakJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private Collection<GrantedAuthority> extractKeycloakRoles(Jwt jwt) {
        ...
        // 1. Extract Realm-Level Roles: { "realm_access": { "roles": ["ROLE_ADMIN", "ROLE_COURIER", "ROLE_MERCHANT", "ROLE_CUSTOMER"] } }
        ...
        // 2. Extract Direct Roles (e.g. "roles": ["CUSTOMER"], "role": "CUSTOMER")
        ...
        // 4. Extract Client-Level Roles: { "resource_access": { "pickup-fleet-service": { "roles": ["fleet:read"] } } }
        ...
        // 5. Extract Fine-Grained Permissions
