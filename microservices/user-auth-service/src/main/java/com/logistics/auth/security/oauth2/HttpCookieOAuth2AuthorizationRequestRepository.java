 ...
 * Stores OAuth2 authorization requests in HTTP cookies to ensure stateless,
 * multi-instance, and cross-domain compatibility (avoiding session loss on OAuth2 redirect).
 */
@Component
