 ...
 * into Spring Security GrantedAuthority instances (e.g. ROLE_ADMIN, ROLE_COURIER, ROLE_DISPATCHER),
...
public class KeycloakJwtAuthenticationConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    private Collection<GrantedAuthority> extractKeycloakRoles(Jwt jwt) {
        ...
        // 1. Extract Realm-Level Roles: { "realm_access": { "roles": ["ROLE_ADMIN", "ROLE_COURIER", "ROLE_DISPATCHER"] } }
        ...
        // 2. Extract Direct Roles from user-auth-service (e.g. "roles": ["COURIER"], "role": "COURIER")
        ...
        // 4. Extract Client-Level Roles: { "resource_access": { "fulfillment-service": { "roles": ["fulfillment:write"] } } }
        ...
        // 5. Extract Fine-Grained Permissions (e.g. "fulfillment:pod", "fulfillment:scan")
